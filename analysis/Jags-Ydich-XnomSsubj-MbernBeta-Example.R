...
#------------------------------------------------------------------------------- 
# Load The data 
#myData = read.csv("~/GitHub/binned_ontimes_new.csv")
#myData = read.csv("~/GitHub/binned_ontimes.csv")
#myData = read.csv("~/GitHub/twobins.csv")
# myData = read.csv("z6N8z2N7.csv")
myData = read.csv("~/GitHub/lenfant_foggybottom_binned.csv")
...
length(myData$OnTime)
finalData = myData[myData$binned_mins_str %in% use_bins, ]
length(finalData$OnTime)
head(finalData)
...
plotMCMC( mcmcCoda , data=finalData , compVal=NULL , #rope=c(0.45,0.55) ,
          compValDiff=0.0 , #ropeDiff = c(-0.05,0.05) ,
          saveName=fileNameRoot , saveType=graphFileType )
#------------------------------------------------------------------------------- 
